...
public class LinearMovement extends MovementModel {
	...
	private Coord initLocSegmentEnd;
	/** Used for node initial location distribution among segment */
	...
	/**
	 * Spreads locations out evenly among the segment defined by initLocSegmentEnd
	 * (initLocType 3)
	 */
	...
	private Coord calculateEndTarget(LinearMovement proto, Coord initLoc) {
		return (proto.startLoc.distance(initLoc) > proto.endLoc.distance(initLoc) ? proto.startLoc : proto.endLoc);
	}
	...
	/**
	 * Sets the initial and end location of the node.
	 * @param initalLoc
	 * @param finalLoc
	 */
	public void setLocation(Coord initalLoc, Coord finalLoc) {
		this.initLoc = initalLoc;
		this.endLoc = finalLoc;
	}
}
